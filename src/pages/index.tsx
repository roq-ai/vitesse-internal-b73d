...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`vitesse-internal`}</title>

        <meta
          name="description"
          content="Experience seamless candidate management with vitesse-internal, your one-stop solution for tracking and understanding your candidates' work status."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1598209494655-b8e249540dfc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYW5kaWRhdGVzfGVufDB8fHx8MTY5NjA5OTMyNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless candidate management with vitesse-internal, your one-stop solution for tracking and understanding your candidates' work status.`}
            </Text>
            <Box
